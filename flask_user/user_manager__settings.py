...
class UserManager__Settings(object):
    ...
    USER_CHANGE_PASSWORD_SUBDOMAIN = '' #:
    USER_CHANGE_USERNAME_SUBDOMAIN = '' #:
    USER_CONFIRM_EMAIL_SUBDOMAIN = '' #:
    USER_EDIT_USER_PROFILE_SUBDOMAIN = '' #:
    USER_EMAIL_ACTION_SUBDOMAIN = '' #:
    USER_FORGOT_PASSWORD_SUBDOMAIN = '' #:
    USER_INVITE_USER_SUBDOMAIN = '' #:
    USER_LOGIN_SUBDOMAIN = '' #:
    USER_LOGOUT_SUBDOMAIN = '' #:
    USER_MANAGE_EMAILS_SUBDOMAIN = '' #:
    USER_REGISTER_SUBDOMAIN = '' #:
    USER_RESEND_EMAIL_CONFIRMATION_SUBDOMAIN = '' #:
    USER_RESET_PASSWORD_SUBDOMAIN = '' #:
